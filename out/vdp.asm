...
; ---------------------------------
_VDP_ClearVRAM::
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\engine/src/vdp.c:254: VDP_FillVRAM_16K(0, 0x0000, 0x4000);  // Clear 16 KB of VRAM
	ld	hl, #0x4000
	push	hl
	ld	de, #0x0000
	xor	a, a
...
;	spillPairReg hl
	ld	a, #0x01
	call	_VDP_RegWriteBakMask
;E:\Dropbox\FAUSTO\SVILUPPI\MSX\CODE\C\MSXgl\engine/src/vdp.c:1617: VDP_EnableVBlank(TRUE);
