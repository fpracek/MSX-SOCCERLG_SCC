...
static const c8 s_ScrollText[] =
    ...
    "SPECIAL THANKS TO ARTURO RAGOZINI FOR HIS HELP WITH SOUND EFFECTS  AND TO NICOLA BROGELLI FOR HIS TESTING AND SUPPORT THROUGHOUT THE GAMES' DEVELOPMENT  -  "
    "THE GAME IS A TRIBUTE TO THE 1983 EXCITING SOCCER  -  "
    "NO COPYRIGHT INFRINGEMENT INTENDED  -  "
	"PRESS 1 FOR ARCADE MATCH SOUND EFFECTS OR 2 FOR CROWD IN STADIUM SOUNDS";
